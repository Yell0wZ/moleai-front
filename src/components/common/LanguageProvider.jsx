...
const translations = {
  en: {
    ...
    'welcome.meetPersona.manualSubtitle': 'Here\'s your customer avatar',
    ...
    'welcome.errors.businessName': 'Please enter a business name to continue.',
    'welcome.errors.description': 'Please describe your business so we can tailor the experience.',
    'welcome.errors.industry': 'Please specify your industry to continue.',
    'welcome.errors.productsServices': 'Please describe your products and services.',
    'welcome.errors.targetMarket': 'Please describe your target market.',
    'welcome.errors.competitors': 'Please add at least one competitor.',
    'welcome.errors.personaName': 'Please enter a name for the avatar to continue.',
    'welcome.errors.personaRole': 'Please enter a role so we understand who this avatar represents.',
    'welcome.errors.personaAge': 'Please enter an age for the avatar.',
    'welcome.errors.personaGoals': 'Please describe the avatar\'s goals.',
    'welcome.errors.personaPainPoints': 'Please describe the avatar\'s pain points and challenges.',
    'welcome.errors.personaLifestyle': 'Please describe the avatar\'s lifestyle.',
    'welcome.errors.personaMotivations': 'Please describe the avatar\'s motivations.',
    'welcome.errors.personaBackstory': 'Please provide personal background for the avatar.',
    'welcome.errors.saving': 'Error saving settings. Please try again.',
    'welcome.errors.profileName': 'Please share your first name so we can personalize the experience.',
    'welcome.errors.profileSubmit': 'Error saving preferences. Please try again.',
    ...
    'competitors.lifeTime': 'Life Time',
    ...
    'analytics.keyThemes': 'Dominant Keywords',
    ...
    'validation.personaNameRequired': 'Avatar name is required',
    'validation.personaRoleRequired': 'Avatar role/job title is required',
    ...
    'errors.personaSaveFailed': 'Error saving avatar. Please ensure all required fields are filled and try again.',
    'errors.aiProcessingFailed': 'Error processing AI response. Please ensure your business profile is complete with business name, industry, and products/services. Please try again.',
    'errors.noDatabaseData': 'No database data available',
    'errors.deleteBusinessFailed': 'Error deleting business',
    'errors.saveCompetitorsFailed': 'Error saving competitors',
    'errors.generateAvatarsFailed': 'Failed to generate avatars.',
    'errors.businessProfileNotFound': 'Business profile not found. Please create a business profile first.',
  ...
  he: {
   ...
   'welcome.profile.hebrew': 'עברית',
    ...
    'welcome.meetPersona.manualSubtitle': 'האווטאר שיצרתם',
    ...
    'analytics.vsLastWeek': 'לעומת שבוע שעבר',
    'analytics.vsCompetitors': 'לעומת מתחרים',
    ...
    // Error Messages (for alerts)
    'errors.personaSaveFailed': 'שגיאה בשמירת האווטאר. אנא ודא שכל השדות הנדרשים מלאים ונסה שוב.',
    'errors.aiProcessingFailed': 'שגיאה בעיבוד תגובת ה-AI. אנא ודא שפרופיל העסק שלך מלא עם שם עסק, תעשייה ומוצרים/שירותים. אנא נסה שוב.',
    'errors.noDatabaseData': 'אין נתוני דטה בייס זמינים',
    'errors.deleteBusinessFailed': 'שגיאה במחיקת העסק',
    'errors.saveCompetitorsFailed': 'שגיאה בשמירת המתחרים',
    'errors.generateAvatarsFailed': 'יצירת האווטארים נכשלה.',
    'errors.businessProfileNotFound': 'פרופיל העסק לא נמצא. אנא צור פרופיל עסק תחילה.',
